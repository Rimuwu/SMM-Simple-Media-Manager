...
from sqlalchemy import JSON, String, BigInteger, ForeignKey
...
class Message(Base, AsyncCRUDMixin):
    """
    ...
    card: Mapped["Card"] = relationship(
        "Card", back_populates="messages", foreign_keys=[card_id], lazy="selectin")
